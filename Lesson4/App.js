...
const resList = [
    {
        ...
        "data": {
            ...
            "cityState": "1",
            "address": "98/A, 17th B Main, Opposite China Pearl, Koramangala 5th Block, Bangalore",
            "locality": "5th Block",
            "parentId": 1405,
            "unserviceable": false,
            "veg": false,
            ...
            "thirdPartyVendor": "",
            "adTrackingID": "cid=6845388~p=1~eid=00000188-4bf1-522c-6be6-6bf8004e0105",
            "badges": {
                "imageBased": [],
                "textBased": [],
                "textExtendedBadges": []
    ...
    },
    {
        ...
        "data": {
            ...
            "thirdPartyAddress": false,
            "thirdPartyVendor": "",
            "adTrackingID": "cid=6845402~p=4~eid=00000188-4bf1-522c-6be6-6bf9004e0403",
            "badges": {
                "imageBased": [],
                "textBased": [],
                "textExtendedBadges": []
    ...
    },
    {
        ...
        "data": {
            ...
            "cityState": "1",
            "address": "BPCL. Petrol Bunk, #344 7th Block, 80 Feet Road Koramangala, Bangalore",
            "locality": "7th Block",
            "parentId": 22,
            "unserviceable": false,
            "veg": true,
            ...
            "thirdPartyAddress": false,
            "thirdPartyVendor": "",
            "adTrackingID": "cid=6843843~p=25~eid=00000188-4bf1-522c-6be6-6c00004e1967",
            "badges": {
                "imageBased": [],
                "textBased": [],
                "textExtendedBadges": []
    ...
    },
    {
        ...
        "data": {
            ...
            "cityState": "1",
            "address": "984, 80 feet road, Crown Tower, Near Maharaja Signal, Koramangala - 560034",
            "locality": "4th Block",
            "parentId": 274773,
            "unserviceable": false,
            "veg": false,
            ...
            "thirdPartyAddress": false,
            "thirdPartyVendor": "",
            "adTrackingID": "cid=6846350~p=13~eid=00000188-4bf1-522c-6be6-6bfc004e0d63",
            "badges": {
                "imageBased": [],
                "textBased": [],
                "textExtendedBadges": []
    ...
    },
    {
        ...
        "data": {
            ...
            "uuid": "fb502bd2-1d53-4211-a859-daf73838d868",
            "city": "1",
            "area": "Btm Layout",
            "totalRatingsString": "1000+ ratings",
            ...
            "slugs": {
                "restaurant": "sri-udupi-sagar-btm-btm",
                "city": "bangalore"
            },
            "cityState": "1",
            "address": "#99, 20th main, 8th Cross,Gangothri Circle, Bangalore",
    ...
    },
    {
        ...
        "data": {
            ...
            "cityState": "1",
            "address": "Natraj Chole Bhature, 30th Cross Rd, Near Bhaskar's Mane holige, Jayanagar East, 4th Block, Jayanagar, Bengaluru, Karnataka 560041",
    ...
    return (
        <div className='header'>
            <div className='logo-container'>
                <img src='https://thumbs.dreamstime.com/b/indian-restaurant-logo-design-authentic-traditional-continental-food-label-can-be-used-cafe-bar-restaurant-menu-vector-119566377.jpg' className='logo'></img>
            </div>
...
const Restaurant_card = (props) => {
    const { resData } = props
    const { name, cuisines, cloudinaryImageId, avgRating, deliveryTime } = resData?.data;
    return (
    ...
    return (
        <div className='body'>
            ...
            <div className='res-container'>
                {resList.map((restaurant) => (< Restaurant_card key={restaurant.data.id} resData={restaurant} />))}
            </div>
        </div>
    )
}
